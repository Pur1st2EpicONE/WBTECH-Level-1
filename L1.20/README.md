...
Finally, the rune slice is converted back into a string and returned. This approach ensures that the word order is reversed correctly for any Unicode string, without allocating additional slices for individual words, and performs all operations in-place.
